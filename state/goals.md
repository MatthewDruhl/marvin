...
- PMP Certification (PMI Project Management Professional)
...
| PMP Certification | Work | In Progress | 96 videos, Section 8 in progress (5/84). TIA course + PMI Study Hall. GI Bill app submitted for exam reimbursement. Target: May 2026. |
...
| Land a new job | Work | In Progress | 3 active apps (Conduent, Iterable, Honor). 21 rejections total. Search strings standardized. No SRE, Java weak. |
